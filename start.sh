...
#
# EDIT From BMARLOT : Ce script n'a pas était écrit par moi, j'ai cependant modifié très peu de choses pour être utilisé sur mon serveur.
#
...
echo "Start script generated by ServerPackCreator 5.1.10."
